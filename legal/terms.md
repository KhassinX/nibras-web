...
These are the terms for using **Nibras**, a reader of the Qur'an for Apple platforms built by **KhassinX** (KHASSINX LLC, a Florida limited liability company).

By installing or using Nibras, you agree to these terms. If you do not agree, do not use the app.
...
Nibras is offered free of charge, pro bono, with no advertising and no subscription. An optional tip jar may be available for those who wish to support the work; it is never required.

The app is provided **"as is"** without warranties of any kind, express or implied, to the maximum extent permitted by applicable law. To the maximum extent permitted by law, KHASSINX LLC is not liable for indirect, incidental, special, consequential, or punitive damages arising from your use of the app. Nothing here excludes liability that cannot be excluded by law.

## Reverence and use

Nibras is intended for reverent reading, study, and reflection. You agree not to use it for any unlawful purpose, and not to reverse-engineer, decompile, or disassemble the app except where applicable law expressly permits.
...
- **English translation of the meaning**: by the **Rowwad Translation Center** (v1.0.19), via **[QuranEnc.com](https://quranenc.com) / [IslamHouse](https://islamhouse.com)**, used under QuranEnc's published Terms and Policies (verbatim, with attribution).
- **English translation of the meaning (classic)**: *The Meaning of the Glorious Koran*, Marmaduke Pickthall, 1930. Public domain.
- **Spanish translation of the meaning**: by **Sheikh Muhammad Isa García** (v1.0.2), via **[QuranEnc.com](https://quranenc.com) / [IslamHouse](https://islamhouse.com)**, used under QuranEnc's published Terms and Policies (verbatim, with attribution).
